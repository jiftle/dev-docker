...
const todolist_1 = __importDefault(__webpack_require__(5));
const todoer_1 = __importDefault(__webpack_require__(136));
const db_1 = __importDefault(__webpack_require__(170));
const guarder_1 = __importDefault(__webpack_require__(182));
const info_1 = __importDefault(__webpack_require__(189));
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = coc_nvim_1.workspace.getConfiguration('todolist');
        const enable = config.get('enable', true);
        if (!enable)
            return;
        const maxsize = config.get('maxsize', 5000);
        const monitor = config.get('monitor', false);
        const autoUpload = config.get('autoUpload', false);
        const type = config.get('notify', 'floating');
        ...
        const todoList = new db_1.default(storagePath, 'todolist', maxsize);
        const info = new info_1.default(storagePath);
        const todoer = new todoer_1.default(todoList, info);
        const guarder = new guarder_1.default(todoList, type);
        subscriptions.push(guarder);
        if (monitor)
            yield guarder.monitor();
        if (autoUpload) {
            const now = new Date();
            const day = new Date(now.getFullYear(), now.getMonth(), now.getDate());
            const last = yield info.fetch('lastUpload');
            if (last && Number(last) < day.getTime()) {
                coc_nvim_1.workspace.showMessage('uploading');
                yield todoer.upload();
            }
        }
        subscriptions.push(coc_nvim_1.commands.registerCommand('todolist.create', () => __awaiter(this, void 0, void 0, function* () { return yield todoer.create(); })));
        subscriptions.push(coc_nvim_1.commands.registerCommand('todolist.upload', () => __awaiter(this, void 0, void 0, function* () { return yield todoer.upload(); })));
        subscriptions.push(coc_nvim_1.commands.registerCommand('todolist.download', () => __awaiter(this, void 0, void 0, function* () { return yield todoer.download(storagePath); })));
        subscriptions.push(coc_nvim_1.commands.registerCommand('todolist.export', () => __awaiter(this, void 0, void 0, function* () { return yield todoer.export(); })));
        subscriptions.push(coc_nvim_1.commands.registerCommand('todolist.clearRemind', () => __awaiter(this, void 0, void 0, function* () { return yield guarder.clearNotice(); })));
        subscriptions.push(coc_nvim_1.listManager.registerList(new todolist_1.default(nvim, todoList)));
    });
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const moment_1 = __importDefault(__webpack_require__(6));
class TodoList extends coc_nvim_1.BasicList {
    constructor(nvim, todoList) {
        super(nvim);
        this.nvim = nvim;
        ...
        this.actions = [];
        this.addAction('toggle', (item) => __awaiter(this, void 0, void 0, function* () {
            const { todo, uid } = item.data;
            const { status } = todo;
            if (status === 'active') {
            ...
            yield this.todoList.update(uid, todo);
        ...
        this.addAction('edit', (item) => __awaiter(this, void 0, void 0, function* () {
            const { uid } = item.data;
            const todo = item.data.todo;
            const config = coc_nvim_1.workspace.getConfiguration('todolist');
            const desc = yield coc_nvim_1.workspace.requestInput('Input new description', todo.desc);
            if (!desc || desc.trim() === '')
                return;
            todo.desc = desc.trim();
            const remind = yield coc_nvim_1.workspace.requestInput('Set a reminder for you?(y/n)');
            if (!remind || remind.trim() === '')
                return;
            if (remind.trim().toLowerCase() === 'y') {
                todo.remind = true;
                const dateFormat = config.get('dateFormat');
                let dueDate = moment_1.default().format(dateFormat);
                dueDate = yield coc_nvim_1.workspace.requestInput('When to remind you', dueDate);
                if (!dueDate || dueDate.trim() === '')
                    return;
                const due = moment_1.default(dueDate.trim(), dateFormat).toDate().toString();
                todo.due = due;
            }
            yield this.todoList.update(uid, todo);
        }));
        this.addAction('delete', (item) => __awaiter(this, void 0, void 0, function* () {
            const { uid } = item.data;
            yield this.todoList.delete(uid);
        }), { persist: true, reload: true });
    }
    compare(a, b) {
    ...
    loadItems(_context) {
        return __awaiter(this, void 0, void 0, function* () {
            const arr = yield this.todoList.load();
            let res = [];
...
const coc_nvim_1 = __webpack_require__(1);
const io_1 = __webpack_require__(2);
const path_1 = __importDefault(__webpack_require__(137));
const gists_1 = __webpack_require__(138);
const moment_1 = __importDefault(__webpack_require__(6));
class Todoer {
    constructor(todoList, info) {
        this.todoList = todoList;
        this.info = info;
        this.gist = new gists_1.Gist();
    }
    getGitHubToken() {
        return __awaiter(this, void 0, void 0, function* () {
            let token = yield this.info.fetch('userToken');
            if (!token) {
                token = yield coc_nvim_1.workspace.requestInput('Input github token');
                if (!token || token.trim() === '')
                    return;
                token = token.trim();
                yield this.info.push('userToken', token);
            }
            return token;
        });
    }
    create() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const config = coc_nvim_1.workspace.getConfiguration('todolist');
            let desc = yield coc_nvim_1.workspace.requestInput('Describe what to do');
            if (!desc || desc.trim() === '')
                return;
            todo.desc = desc.trim();
            if (config.get('promptForReminder')) {
                const remind = yield coc_nvim_1.workspace.requestInput('Set a reminder for you?(y/n)');
                if (!remind || remind.trim() === '')
                    return;
                if (remind.trim().toLowerCase() === 'y') {
            ...
            yield this.todoList.add(todo);
            coc_nvim_1.workspace.showMessage('New todo added');
        });
    }
    download(directory) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let gistid = yield this.info.fetch('gistId');
            if (!gistid || gistid.trim() === '') {
                gistid = yield coc_nvim_1.workspace.requestInput('Input gist id');
                if (!gistid || gistid.trim() === '')
                    return;
                gistid = gistid.trim();
                yield this.info.push('gistId', gistid);
            }
            statusItem.show();
            const res = yield this.gist.get(`/gists/${gistid}`);
            statusItem.hide();
            if (res.status == 200 && res.responseText) {
                const gist = JSON.parse(res.responseText);
                const todoFile = path_1.default.join(directory, 'todolist.json');
                const todoFileBak = path_1.default.join(directory, 'todolist.json.old');
                const stat = yield io_1.statAsync(todoFile);
                if (stat && stat.isFile()) {
                    yield coc_nvim_1.workspace.renameFile(todoFile, todoFileBak, { overwrite: true });
                }
                const { content } = gist.files['todolist.json'];
                if (content) {
                    const todos = JSON.parse(content);
                    yield this.todoList.updateAll(todos);
                    coc_nvim_1.workspace.showMessage('Downloaded todolist from gist');
                }
            }
            else if (res.status === 404) {
                coc_nvim_1.workspace.showMessage('Remote gist was not found', 'error');
                yield this.info.delete('gistId');
                return;
            }
            else {
                coc_nvim_1.workspace.showMessage('Downloading error', 'error');
                return;
            }
        });
    }
    upload() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.gist.token = yield this.getGitHubToken(); // TODO
            const record = yield this.todoList.load();
            ...
            if (gistId && gistId.trim()) {
                statusItem.show();
                const res = yield this.gist.patch(`/gists/${gistId}`, data);
                statusItem.hide();
                if (res.status === 200) {
                    coc_nvim_1.workspace.showMessage('Updated gist todolist');
                    yield this.updateLog();
                    return;
                }
                else if (res.status !== 404) {
                    coc_nvim_1.workspace.showMessage('Failed to uploaded todo gist', 'error');
                    return;
                }
            ...
            const res = yield this.gist.post('/gists', data);
            if (res.status == 201 && res.responseText) {
                const gist = JSON.parse(res.responseText);
                yield this.info.push('gistId', gist.id);
                coc_nvim_1.workspace.showMessage('Uploaded a new todolist to gist');
                yield this.updateLog();
            }
            else {
                coc_nvim_1.workspace.showMessage('Failed to create todolist from gist', 'error');
                return;
            }
        });
    }
    updateLog() {
        return __awaiter(this, void 0, void 0, function* () {
            const now = new Date();
            const day = new Date(now.getFullYear(), now.getMonth(), now.getDate());
            yield this.info.push('lastUpload', day.getTime());
        });
    }
    export() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filetype = yield nvim.call('confirm', ['Export filetype:', '&JSON\n&YAML']);
            if (filetype === 1) {
                const lines = JSON.stringify(todo, null, 2).split('\n');
                yield nvim.command('tabnew');
                yield nvim.command('set syntax=json');
                yield nvim.call('append', [0, lines]);
            }
            else if (filetype === 2) {
                const lines = todo.map(t => Object.keys(t)
                    ...
                    .join('\n\n').split('\n');
                yield nvim.command('tabnew');
                yield nvim.command('set syntax=yaml');
                yield nvim.call('append', [0, lines]);
            }
            else {
                return;
...
Object.defineProperty(exports, "__esModule", { value: true });
const request_light_1 = __webpack_require__(139);
const url_1 = __webpack_require__(140);
class Gist {
    constructor() {
        this.token = '';
        //
    ...
    post(path, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.request('POST', path, data);
        });
    }
    patch(path, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.request('PATCH', path, data);
        });
    }
    request(method, path, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const url = url_1.resolve('https://api.github.com/', path);
            const xhrOptions = {
                type: method,
                url,
                data,
            ...
            try {
                return yield request_light_1.xhr(xhrOptions);
            }
            catch (e) {
                return e;
            }
...
Object.defineProperty(exports, "__esModule", { value: true });
var url_1 = __webpack_require__(140);
var https = __webpack_require__(141);
var http = __webpack_require__(142);
var HttpProxyAgent = __webpack_require__(143);
var HttpsProxyAgent = __webpack_require__(161);
var zlib = __webpack_require__(168);
var nls = __webpack_require__(169);
...
var net = __webpack_require__(144);
var tls = __webpack_require__(145);
var url = __webpack_require__(140);
var Agent = __webpack_require__(146);
var inherits = __webpack_require__(4).inherits;
var debug = __webpack_require__(152)('http-proxy-agent');
...
const promisify = __webpack_require__(148);
const EventEmitter = __webpack_require__(151).EventEmitter;
...
const url = __webpack_require__(140);
const https = __webpack_require__(141);
...
module.exports = function () {
    ...
    var ES6Promise = __webpack_require__(149);
...
module.exports = function () {
    ...
    return __webpack_require__(150).Promise;
}();
...
var tty = __webpack_require__(157);
...
const os = __webpack_require__(159);
const hasFlag = __webpack_require__(160);
...
var Agent = __webpack_require__(146);
var inherits = __webpack_require__(4).inherits;
var debug = __webpack_require__(163)('https-proxy-agent');
...
module.exports = __webpack_require__(165)(exports);
...
const io_1 = __webpack_require__(2);
const path_1 = __importDefault(__webpack_require__(137));
const uuid = __webpack_require__(171);
class DB {
    ...
    updateAll(data) {
        return __awaiter(this, void 0, void 0, function* () {
            yield io_1.writeFile(this.file, '[]');
            for (const t of data) {
                yield this.add(t);
            }
        });
    ...
    dump(data) {
        return __awaiter(this, void 0, void 0, function* () {
            yield io_1.writeFile(this.file, JSON.stringify(data, null, 2));
        });
    }
}
exports.default = DB;
...
/* harmony import */ var _v1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(172);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "v1", function() { return _v1_js__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _v3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(176);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "v3", function() { return _v3_js__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _v4_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(179);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "v4", function() { return _v4_js__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _v5_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(180);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _rng_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(173);
/* harmony import */ var _bytesToUuid_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(175);
...
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(174);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(177);
/* harmony import */ var _md5_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(178);
...
/* harmony import */ var _bytesToUuid_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(175);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(177);
/* harmony import */ var _sha1_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(181);
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const floatWindow_1 = __importDefault(__webpack_require__(183));
const virtualText_1 = __importDefault(__webpack_require__(187));
const dispose_1 = __webpack_require__(188);
class Guarder extends dispose_1.Dispose {
    constructor(todoList, type) {
        super();
        this.todoList = todoList;
        this.type = type;
        this.nvim = coc_nvim_1.workspace.nvim;
        this.floating = new floatWindow_1.default(this.nvim);
        this.virtual = new virtualText_1.default(this.nvim);
    }
    notify(todo) {
        return __awaiter(this, void 0, void 0, function* () {
            const notice = {
            ...
            switch (this.type) {
                case 'floating':
                    try {
                        yield this.floating.start(notice);
                        return;
                    }
                    catch (_e) {
                        coc_nvim_1.workspace.showMessage(_e);
                ...
                case 'virtual':
                    try {
                        ...
                        yield this.virtual.showInfo(bufnr, lnum, msg);
                        // TODO: how to delete this event?
                        coc_nvim_1.events.on('CursorMoved', (bufnr, cursor) => __awaiter(this, void 0, void 0, function* () {
                            yield this.virtual.showInfo(bufnr, cursor[0], msg);
                        }));
                        return;
                    }
                    catch (_e) {
    ...
    monitor() {
        return __awaiter(this, void 0, void 0, function* () {
            this.interval = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                const todolist = yield this.todoList.load();
                ...
                for (const a of todolist) {
                    ...
                    if (remind && due && Date.parse(due) <= now && status == 'active') {
                        yield this.notify(todo);
                        yield this.deactive(uid, todo);
                    }
                }
            }), 1000); // TODO
        });
    ...
    clearNotice() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.floating.destroy();
            yield this.virtual.destroy();
        });
    }
    stopGuard() {
        if (this.interval)
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const highligher_1 = __importDefault(__webpack_require__(184));
class FloatWindow {
    constructor(nvim) {
        this.nvim = nvim;
        this.window = null;
        ...
        this.width = 30;
        this.height = 4;
        this.config = coc_nvim_1.workspace.getConfiguration('todolist.floatwin');
        coc_nvim_1.workspace.onDidChangeConfiguration(e => {
            if (e.affectsConfiguration('todolist.floatwin')) {
                this.config = coc_nvim_1.workspace.getConfiguration('todolist.floatwin');
            }
        });
        this.width = this.config.get('width', 30);
    }
    getWinConfig() {
        return __awaiter(this, void 0, void 0, function* () {
            const height = yield this.nvim.getOption('lines');
            const width = yield this.nvim.getOption('columns');
            const winConfig = {
                focusable: false,
                relative: 'editor',
                anchor: 'NW',
    ...
    render(notice) {
        return __awaiter(this, void 0, void 0, function* () {
            const hl = new highligher_1.default();
    ...
    moveUp(windows) {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(windows.map((w) => __awaiter(this, void 0, void 0, function* () {
                const isValid = yield w.valid;
                if (isValid) {
                    const winConfig = yield w.getConfig();
                    for (let i = 0; i <= this.height; i++) {
                        winConfig.row -= 1;
                        yield w.setConfig(winConfig);
    ...
    noMoreWins() {
        return __awaiter(this, void 0, void 0, function* () {
            const winblend = this.config.get('winblend', 0);
            ...
            if (this.windows.length > 1) {
                ...
                setImmediate(() => __awaiter(this, void 0, void 0, function* () {
                    for (let i = winblend; i <= 100; i++) {
                        yield discard.setOption('winblend', i);
                        yield new Promise(resolve => setTimeout(resolve, 500 / (100 - winblend)));
                    }
                    yield discard.close(true);
                    this.tempWins.shift();
                }));
            }
        });
    ...
    create(buf) {
        return __awaiter(this, void 0, void 0, function* () {
            const winConfig = yield this.getWinConfig();
            this.window = yield this.nvim.openFloatWindow(buf, false, winConfig);
            this.windows.push(this.window);
            const { window, nvim } = this;
            nvim.pauseNotification();
            const winblend = this.config.get('winblend', 0);
            const floatwinBg = this.config.get('background');
            if (floatwinBg) {
            ...
            yield this.moveUp(this.windows.concat(this.tempWins));
            yield this.noMoreWins();
        });
    }
    start(notice) {
        return __awaiter(this, void 0, void 0, function* () {
            const buf = yield this.nvim.createNewBuffer();
            buf.setOption('bufhidden', 'wipe', true);
            buf.setOption('buftype', 'nowrite', true);
            const renderer = yield this.render(notice);
            // buffer was changed here
            renderer.render(buf);
            yield this.create(buf);
        });
    }
    destroy() {
        return __awaiter(this, void 0, void 0, function* () {
...
Object.defineProperty(exports, "__esModule", { value: true });
const ansiparse_1 = __webpack_require__(185);
const string_1 = __webpack_require__(186);
/**
...
class VirtualText {
    ...
    showInfo(bufnr, lnum, text) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.virtualTextSrcId = yield this.nvim.createNamespace('coc-todolist');
            const buffer = yield this.nvim.buffer;
            yield buffer.setVirtualText(this.virtualTextSrcId, lnum - 1, [[text, 'WarningMsg']]);
        });
    }
    destroy() {
        return __awaiter(this, void 0, void 0, function* () {
            const buffer = yield this.nvim.buffer;
            const doc = coc_nvim_1.workspace.getDocument(buffer.id);
            if (doc && this.virtualTextSrcId) {
                doc.buffer.clearNamespace(this.virtualTextSrcId, 0, -1);
                this.show = false;
            }
...
class TodolistInfo {
    constructor(directory) {
        this.file = path_1.default.join(directory, 'config.json');
    }
    load() {
        return __awaiter(this, void 0, void 0, function* () {
            let stat = yield io_1.statAsync(this.file);
    ...
    delete(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof obj[key] == 'undefined')
                return;
            delete obj[key];
            yield io_1.writeFile(this.file, JSON.stringify(obj, null, 2));
        });
    }
    push(key, data) {
        return __awaiter(this, void 0, void 0, function* () {
